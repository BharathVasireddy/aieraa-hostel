              ...
              <div className='relative'>
                ...
                >
                  <div className='flex items-center space-x-2'>
                    ...
                    <ChevronDown
                      className={`w-3 h-3 text-green-600 transition-transform duration-200 ${showDatePickerDropdown ? 'rotate-180' : ''}`}
                    />
                  </div>
                </button>
                  ...
                  <div className='absolute right-0 mt-2 w-72 bg-white border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden animate-scale-in'>
                    <div className='bg-green-50 px-4 py-3 border-b border-green-200'>
                      ...
                      <p className='text-xs text-green-700'>
                        Choose when you&apos;d like to collect your hostel meal
                      </p>
                    </div>
                      ...
                      {availableDates.map(dateOption => (
                        ...
                        >
                          <div className='flex items-center justify-between'>
                            <div className='flex items-center space-x-3'>
                              <div
                                className={`w-10 h-10 rounded-xl flex flex-col items-center justify-center text-xs transition-colors duration-200 ${
                                  selectedDate === dateOption.date

...
const TodaysSpecials: React.FC<TodaysSpecialsProps> = ({ specials, loading }) => {
    ...
    <div className="bg-white rounded-xl p-4 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-lg font-semibold text-gray-900">Today's Specials</h2>
        </div>
        <button
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  <span className="text-sm font-semibold text-green-600">₹{special.offerPrice}</span>
                  <span className="text-xs bg-red-100 text-red-800 px-2 py-1 rounded-full">
                    {Math.round(((special.originalPrice - special.offerPrice) / special.originalPrice) * 100)}% OFF
                  </span>
                </div>
              </div>
            </div>

...
const VAPID_PUBLIC_KEY = process.env.NEXT_PUBLIC_VAPID_PUBLIC_KEY || 'BJ24omJ9PPmTnTbuSbFBPLYxxBYIgVoEWgH6mo9NKrg0vovXhKO3oAc9I3_GM554UytSuuGKP_P475LFxmzi3VM'
...
export default function PushNotifications() {
  ...
  const checkSubscription = async () => {
    try {
      ...
      const dismissed = localStorage.getItem('push-notifications-dismissed') === 'true'

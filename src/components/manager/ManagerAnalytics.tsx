...
const ManagerAnalytics = memo<ManagerAnalyticsProps>(({ universityId, stats }) => {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100">
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 text-sm text-green-600">
            ...
            <span className="font-medium">+{stats.weeklyGrowth}% this week</span>
          </div>
        </div>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="text-center">
            <p className="text-2xl font-bold text-gray-900">
              {Math.round(weeklyData.reduce((sum, d) => sum + d.revenue, 0) / weeklyData.reduce((sum, d) => sum + d.orders, 0) || 0)}
            </p>
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-gray-900">Daily Orders This Week</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <p className="text-blue-700">
                {weeklyData.reduce((max, day) => day.orders > max.orders ? day : max, weeklyData[0])?.day || 'N/A'} with{' '}
                {Math.max(...weeklyData.map(d => d.orders))} orders
              </p>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm font-medium text-green-900">Avg Processing</span>
              </div>

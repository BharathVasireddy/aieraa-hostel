...
import { ShoppingCart, Clock, DollarSign, Users, TrendingUp, RefreshCw } from 'lucide-react'
...
const StatCard = memo<StatCardProps>(({ title, value, icon: Icon, color, change, loading }) => {
  if (loading) {
    return (
...
const StatsCardGrid = memo<StatsCardGridProps>(({ stats, loading, onRefresh }) => {
  const statCards = [
    {

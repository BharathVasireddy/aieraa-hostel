...
export async function GET(
  ...
  try {
    ...
    console.log('API: Fetching order with number:', orderNumber, 'for user:', session.user.id)
    ...
    console.log('API: Order found successfully by number:', order.orderNumber, 'for user:', order.userId)

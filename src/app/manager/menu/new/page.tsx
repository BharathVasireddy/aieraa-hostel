...
const CATEGORIES = [
  ...
  { value: 'BEVERAGES', label: 'Beverages', color: 'bg-pink-100 text-pink-800' }
]
...
export default function AddMenuItemPage() {
  ...
  const validateForm = (): string | null => {
    ...
    for (let i = 0; i < formData.variants.length; i++) {
      ...
      if (variant.price <= 0) return `Variant ${i + 1} price must be greater than 0`
    }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Create a new menu item for {user?.university?.name || 'your university'}</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange('offerPrice', e.target.value ? Number(e.target.value) : null)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                    min="0"
                    step="1"
          ...
          <div className="space-y-6">
            {/* Item Properties */}
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Item Properties</h2>
            ...
            {/* Allergens */}
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Allergens</h2>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-blue-900">Availability Management</h3>
                  <p className="text-sm text-blue-700 mt-1">
                    After creating this item, you can set its availability schedule using the calendar icon in the menu management table.
                  </p>
                </div>
              </div>
            </div>

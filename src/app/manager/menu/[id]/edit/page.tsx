      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Update menu item for {user?.university?.name || 'your university'}</p>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    Use the calendar icon in the menu management table or the item details page to set availability schedule for this item.
                  </p>
                </div>
              </div>
            </div>

...
export default function AdminAnalytics() {
  ...
  const fetchAnalytics = useCallback(async () => {
    try {
      ...
      // Handle error silently - analytics refresh failures are non-critical
    } finally {
      setLoading(false);
    }
  }, [selectedPeriod]);
  ...
  const handlePeriodChange = (period: string) => {
    ...
    // Analytics will be refetched automatically via useEffect when selectedPeriod changes
  };
    ...
    <div className='min-h-screen bg-gray-50 pb-20'>
      ...
      <div className='px-4 py-4 space-y-6'>
        ...
        <div className='grid grid-cols-2 gap-3'>
          <div className='bg-blue-50 rounded-lg p-4 border border-blue-100'>
            <div className='flex items-center justify-between mb-2'>
              ...
              <div
                className={`flex items-center ${getGrowthColor(analytics.keyMetrics.revenueGrowth)}`}
              >
          ...
          <div className='bg-green-50 rounded-lg p-4 border border-green-100'>
            <div className='flex items-center justify-between mb-2'>
              ...
              <div
                className={`flex items-center ${getGrowthColor(analytics.keyMetrics.orderGrowth)}`}
              >
            ...
            <div className='flex items-center justify-between mb-2'>
              ...
              <div className='text-orange-600'>
                <span className='text-xs font-medium'>
                  ...
                  {analytics.keyMetrics.totalStudents}
                </span>
              </div>
            </div>
            <div>
            ...
            {[
              {
                key: 'heavy',
                segment: 'Heavy Users',
                ...(analytics.studentSegments?.heavy || {
                  count: 0,
                  avgSpend: 0,
                }),
              ...
              },
              {
                ...
                ...(analytics.studentSegments?.regular || {
                  count: 0,
                  avgSpend: 0,
                }),
              ...
              },
              {
                ...
                ...(analytics.studentSegments?.occasional || {
                  count: 0,
                  avgSpend: 0,
                }),
              ...
              >
                <div className='flex items-center space-x-3'>
                  <div
                    className={`px-2 py-1 rounded-md text-xs font-medium ${segment.color}`}
                  >
                    {segment.segment}
                  </div>
        ...
        <div className='bg-white border border-gray-100 rounded-lg p-4'>
          ...
          {!analytics.orderStatusStats ||
          analytics.orderStatusStats.length === 0 ? (
            <div className='text-center py-8 text-gray-500'>

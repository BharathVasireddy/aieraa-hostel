...
import { ArrowLeft, Edit3, Eye, EyeOff, Plus, Star, Zap } from 'lucide-react';
            ...
            <div>
              <div className='flex items-center justify-between mb-4'>
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    Manage which dishes appear in the popular section
                  </p>
                </div>
              ...
              <div className='mt-6'>
                ...
                <div className='grid grid-cols-1 gap-3'>
                  {availableItems
                    .filter(
                      item => !popularDishes.find(dish => dish.id === item.id)
                    )
                    .map(item => (
                      <div
                        key={item.id}
            ...
            <div>
              <div className='flex items-center justify-between mb-4'>
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    Manage featured items with special offers
                  </p>
                </div>
                <span className='text-sm text-gray-500'>
                  {todaysSpecials.filter(special => special.isActive).length}{' '}
                  active
                </span>
              </div>
              ...
              <div className='mt-6'>
                ...
                <div className='grid grid-cols-1 gap-3'>
                  {availableItems
                    .filter(
                      item =>
                        !todaysSpecials.find(special => special.id === item.id)
                    )
                    .map(item => (
                      <div
                        key={item.id}

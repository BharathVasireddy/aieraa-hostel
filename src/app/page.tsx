      ...
      <section className='py-20 px-4'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-xl text-gray-600 mb-8 max-w-2xl mx-auto'>
            Skip the queue, save time, and enjoy fresh meals delivered right to
            your room. Order today for tomorrow&apos;s meals.
          </p>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Pre-order your meals and skip the long queues. More time for
                what matters.
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Enjoy freshly prepared meals made with quality ingredients every
                day.
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Safe and secure payment options with university-verified
                accounts.
              </p>
            </div>
      ...
      <section className='py-16 px-4 bg-green-600'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-xl text-green-100 mb-8'>
            Join thousands of students who are already saving time with Aieraa
            Hostel App.
          </p>
          {status === 'authenticated' ? (
            <button
      ...
      <footer className='bg-gray-900 text-white py-8 px-4'>
        <div className='max-w-6xl mx-auto text-center'>
          ...
          <p className='text-gray-400 mb-4'>
            Making hostel dining convenient and enjoyable for students
            worldwide.
          </p>

    ...
    switch (status) {
      case 'PENDING':
        return {
          ...
          description:
            'We have received your order and it will be reviewed shortly.',
        };
      case 'APPROVED':
        return {
          color: 'bg-blue-500',
          ...
          description:
            'Great! Your order has been approved and is now in the preparation queue.',
        };
      case 'PREPARING':
        return {
          color: 'bg-purple-500',
          ...
          description:
            'Your food is currently being prepared in our kitchen with love and care.',
        };
      case 'READY':
        return {
          color: 'bg-green-500',
          ...
          description:
            'Your order is ready and waiting for you at the collection counter.',
        };
      case 'SERVED':
        return {
      ...
      case 'REJECTED':
        return {
          ...
          description:
            'Unfortunately, your order could not be processed. You will receive a full refund.',
        };
      case 'CANCELLED':
        return {
          color: 'bg-gray-500',
          ...
          subtitle: 'Your order has been cancelled',
          description:
            'Your order has been cancelled. You will receive a full refund if payment was made.',
        };
      default:
        return {
          color: 'bg-gray-500',
      ...
      <div className='px-4 py-6 space-y-6'>
        ...
        <div className='text-center py-8'>
          <div className='relative'>
            <div
              className={`w-24 h-24 ${statusConfig.bgColor} rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse`}
            >
              <div
                className={`w-20 h-20 ${statusConfig.color} rounded-full flex items-center justify-center animate-bounce`}
              >
          ...
          <p className='text-lg text-gray-600 mb-2'>{statusConfig.subtitle}</p>
          ...
          <div className='space-y-4'>
            <div className='flex items-center space-x-4 p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl'>
              ...
              <div>
                ...
                <p className='text-sm text-gray-500'>
                  {order.user.university.address || 'University Campus'}
                </p>
              </div>
            </div>
            ...
            <div className='flex items-center space-x-4 p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-xl'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  Room {order.user.roomNumber || 'Not specified'}
                </p>
                <p className='text-sm text-gray-500'>
            ...
            <div className='flex items-center space-x-4 p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  {formatDate(order?.orderDate, 'EEEE, MMM dd', 'Today')} •
                  12:00 PM - 2:00 PM
                </p>
                <p className='text-sm text-gray-500'>
                  Payment:{' '}

...
export default function StudentDashboard() {
  ...
  return (
    <StudentLayout>
          ...
          <div className='flex items-center justify-between'>
            <div>
              <h2 className='text-base font-bold mb-0.5'>
                Good {getVietnamGreeting()}, {user.name.split(' ')[0]}! 👋
              </h2>
      ...
      {/* Promotional Slider */}
      {user.university?.id && (
        <PromotionalSlider universityId={user.university.id} />
      )}
          ...
          {loadingDishes ? (
            <div className='flex space-x-3 overflow-x-auto pb-2'>
              {[1, 2, 3].map(i => (
                <div
                  key={i}
                  className='flex-shrink-0 w-40 bg-white rounded-2xl p-3 border border-gray-100 shadow-sm animate-pulse'
                >
